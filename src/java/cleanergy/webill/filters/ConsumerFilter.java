 ...
 */
package cleanergy.webill.filters;
...
public class ConsumerFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String reqUri = httpRequest.getRequestURI().trim();
        ...
        if (!user.getRole().equalsIgnoreCase("consumer")){
            ...
            errors.put("login","Please log in as an administrator");
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("ConsumerFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("ConsumerFilter(");
